...
const subTitle = "Top B.Tech CSE College in Kolkata";
const title = <h2 className="title"><span className="d-lg-block">B.Tech In Computer Science</span> And Engineering <span className="d-lg-block"> (CSE)</span></h2>;
const desc = "";
